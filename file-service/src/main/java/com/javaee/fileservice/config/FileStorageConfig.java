...
public class FileStorageConfig {
    ...
    @Value("${file.storage.max-batch-files:100}")
    private int maxBatchFiles;

    @Value("${file.storage.max-batch-total-size-mb:1024}")
    private long maxBatchTotalSizeMb;

    @Value("${file.storage.max-batch-concurrency:1}")
    ...
    public long getMaxBatchTotalSizeMb() {
        return maxBatchTotalSizeMb;
    }

    public int getMaxBatchConcurrency() {
