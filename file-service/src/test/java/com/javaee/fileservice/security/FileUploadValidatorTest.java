...
class FileUploadValidatorTest {
    ...
    @Test
    void validatesMergedBytesWithTheSameSignatureRules() {
        assertThatCode(() -> validator.validateBytes("note.txt", "text".getBytes(StandardCharsets.UTF_8)))
                .doesNotThrowAnyException();
        assertThatThrownBy(() -> validator.validateBytes("report.pdf", "not a pdf".getBytes(StandardCharsets.UTF_8)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("扩展名不匹配");
    }
}
