...
public class ToolboxJobController {
    ...
    @PostMapping("/{jobId}/retry") public Result<Map<String, Object>> retry(@PathVariable String jobId) { return Result.success(jobs.retry(jobId, users.getRequiredUserId())); }
