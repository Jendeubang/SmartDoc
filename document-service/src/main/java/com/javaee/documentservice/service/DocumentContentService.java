...
public interface DocumentContentService {
    ...
    /**
     * 根据指定 key 和 bucket 直接从 MinIO 获取内容
     * @param key MinIO 对象键
     * @param bucketName 桶名
     * @return 文档内容
     */
    String getContentByKey(String key, String bucketName);

    /**
     * 根据指定 key 和 bucket 保存内容到 MinIO
     * @param key MinIO 对象键
     * @param bucketName 桶名
     * @param content 内容
     * @return 是否成功
     */
    boolean saveContentByKey(String key, String bucketName, String content);
}
