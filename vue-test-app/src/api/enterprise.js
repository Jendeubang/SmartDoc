...
export const enterpriseApi = {
  ...
  registeredUsers: (keyword = '') => request.get('/users/directory', { params: { keyword } }),
  ...
  syncDocuments: data => request.put('/enterprise/documents/sync', data),
  removeDocument: documentId => request.delete(`/enterprise/documents/${documentId}/location`),
